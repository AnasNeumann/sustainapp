...
public class MissionSpecification {
	 ...
	 */
	public static Specification<MissionEntity> searchByCriteres(final MissionCriteria criteres) {
		return new Specification<MissionEntity>() {
			@Override
			public Predicate toPredicate(Root<MissionEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
