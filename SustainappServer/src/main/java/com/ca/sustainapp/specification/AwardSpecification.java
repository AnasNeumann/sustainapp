 ...
 * @version 1.0
 */
public class AwardSpecification {
	/**
	 * private constructor
	 */
	private AwardSpecification(){
	 ...
	 */
	public static Specification<AwardEntity> searchByCriteres(final AwardCriteria criteres) {
		return new Specification<AwardEntity>() {
			@Override
			public Predicate toPredicate(Root<AwardEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
