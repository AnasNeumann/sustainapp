 ...
 * @version 1.0
 */
public class ProfilBadgeSpecification {
	
	/**
	 * private constructor
	 */
	private ProfilBadgeSpecification(){
	...
	public static Specification<ProfilBadgeEntity> searchByCriteres(final ProfilBadgeCriteria criteres) {
		return new Specification<ProfilBadgeEntity>() {
			@Override
			public Predicate toPredicate(Root<ProfilBadgeEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
