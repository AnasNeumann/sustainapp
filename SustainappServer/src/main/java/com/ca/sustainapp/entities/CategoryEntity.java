...
public class CategoryEntity extends GenericEntity implements Serializable {
	 ...
	 */
	public CategoryEntity setTimestamps(Calendar timestamps) {
	 ...
	 */
	public CategoryEntity setBase64(String base64) {
		this.base64 = base64;
		return this;
	}
}